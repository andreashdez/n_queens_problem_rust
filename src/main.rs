...
const DEFAULT_BOARD_SIZE: u16 = ga::DEFAULT_BOARD_SIZE;
const DEFAULT_POPULATION_SIZE: usize = ga::DEFAULT_POPULATION_SIZE;
const DEFAULT_MAX_EPOCHS: u32 = ga::DEFAULT_MAX_EPOCHS;
